    ...
    public class RepositoryFactories
    {
        ...
        private IDictionary<Type, Func<DbContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                    /*here's a example fo how to add one
        ...
        /// </remarks>
        public Func<Context, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        protected virtual Func<Context, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
