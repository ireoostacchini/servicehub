...
namespace ServiceHub.DataAccess
{
    ...
    /// We create a new provider per client request.
    /// </remarks>
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        /// Get and set the <see cref="Context"/> with which to initialize a repository
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<Context, object> factory = null) where T : class
        {
        ...
        /// <param name="context">
        /// The <see cref="Context"/> with which to initialize the repository.
        /// </param>        
        /// <param name="factory">
        /// Factory with <see cref="Context"/> argument. Used to make the repository.
        /// If null, gets factory from <see cref="_repositoryFactories"/>.
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<Context, object> factory, Context context)
        {
