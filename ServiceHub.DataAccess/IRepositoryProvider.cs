...
namespace ServiceHub.DataAccess
{
    ...
    /// </summary>
    /// <remarks>
    /// Repositories created by this provider tend to require a <see cref="Context"/>
    /// to retrieve data.
    /// </remarks>
    public interface IRepositoryProvider
    {
        ...
        /// </typeparam>
        /// <param name="factory">
        /// An optional repository creation function that takes a <see cref="Context"/>
        ...
        /// </remarks>
        T GetRepository<T>(Func<Context, object> factory = null) where T : class;
